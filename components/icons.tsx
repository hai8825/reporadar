...
export const SparkleIcon = ({ className }: IconProps) => (
  <svg viewBox="0 0 16 16" className={className} fill="currentColor" aria-hidden>
    <path d="M8 1c.4 3.3 1.7 4.6 5 5-3.3.4-4.6 1.7-5 5-.4-3.3-1.7-4.6-5-5 3.3-.4 4.6-1.7 5-5Z" />
  </svg>
);
...
export const LicenseIcon = ({ className }: IconProps) => (
  <svg
    viewBox="0 0 16 16"
    className={className}
    fill="none"
    ...
    aria-hidden
  >
    <path d="M8 2.75v10.5M5 13.25h6M3.5 5.5h9M2 9l1.5-3.5L5 9M11 9l1.5-3.5L14 9" />
  </svg>
);
...
export const TagIcon = ({ className }: IconProps) => (
  <svg
    ...
    aria-hidden
  >
    <path d="M2.75 8 8 2.75h4.5V7.25L7.25 12.5a1 1 0 0 1-1.4 0L2.75 9.4a1 1 0 0 1 0-1.4Z" />
    <circle cx="10" cy="5.5" r="0.6" />
  </svg>
);
